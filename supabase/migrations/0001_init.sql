-- =============================================================
-- Memorial CMS – Complete schema (run once in Supabase SQL Editor)
-- =============================================================
...
-- Bulletins (Berlin Bulletin entries)
...
-- Authenticated users (your admin account) get full CRUD access
do $$ begin
...
-- Public read access (for your public-facing website to display content)
do $$ begin
